...
//    new LocalDirAllocator("mapred.local.dir");
  ...
  public static TextPairIterator merge(DataInputStream[] inputs) throws IOException {
	  return new MergeQueue(inputs).merge();
  }
...
/*
  ...
  extends PriorityQueue<Segment> implements TextPairIterator {
    //Configuration conf;
    //FileSystem fs;
    ...
    public MergeQueue(DataInputStream[] dis
    ...
    */
    ...
    public Text getKey() throws IOException {
      return key;
    }

    public Text getValue() throws IOException {
      return value;
    }
...
/*      long endPos = reader.getPosition();
    ...
    protected boolean lessThan(Object a, Object b) {
      Text key1 = ((Segment)a).getKey();
      Text key2 = ((Segment)b).getKey();
